...
const Core = require("@octokit/rest/lib/core");

const CORE_PLUGINS = [
  require("@octokit/rest/plugins/authentication"),
  require("@octokit/rest/plugins/authentication-deprecated"), // deprecated: remove in v17
  requestLog,
  require("@octokit/rest/plugins/pagination"),
  restEndpointMethods,
  require("@octokit/rest/plugins/validate"),
